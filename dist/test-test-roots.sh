...
while IFS= read -r module; do
    case "$module" in
        ...
        ui/*|render/*|a11y/nsax.zig|a11y/view.zig|audio_sink.zig|doctor.zig|filebrowser/transfers.zig|ipc/appdrive.zig|ipc/mcp.zig|ipc/mcp_app.zig|ipc/mcp_term.zig|ipc/mcp_web.zig|ipc/mcp_webgui.zig|remote_menu.zig|remote_window.zig|terminal.zig|util/gifrec.zig|wlapp.zig)
            class=gui
            ;;
        *)
            class=core
