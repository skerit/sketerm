...
pub const TOOLS = [_]ToolDef{
    ...
    .{
        ...
        ,
        .output_schema = WEB_RESULT_HEAD ++
            \\"waited_for":{"type":"string","enum":["load","title","text","idle"]},"arg":{"type":"string"},"settled":{"type":"boolean","description":"Always true; a condition that never held is an isError timeout"},"detail":{"type":"string","description":"What made the condition hold"}},"required":["backend","origin","url","title","loading","waited_for","settled","detail"]}
        ,
    },
