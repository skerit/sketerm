...
pub const TOOLS = [_]ToolDef{
    ...
    .{
        ...
        ,
        .input_schema =
        \\{"type":"object","properties":{"pane":{"type":"integer","description":"Tighten this live view's policy"},"view":{"type":"integer","description":"Synonym for 'pane'"},"profile":{"type":"string","description":"Register the session default for this profile name instead"},"policy":{"type":"object","description":"Same shape as web_open's policy object"}},"required":["policy"]}
        ,
        .output_schema =
