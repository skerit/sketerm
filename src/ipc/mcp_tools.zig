...
pub const TOOLS = [_]ToolDef{
    ...
    .{
        ...
        ,
        .output_schema =
        \\{"type":"object","properties":{"backend":{"type":"string","enum":["gui","headless"]},"count":{"type":"integer"},"helper":{"type":"string","description":"Browser-helper state: ready, idle, unavailable"},"helper_reason":{"type":"string"},"views":{"type":"array","items":{"type":"object","properties":{"pane":{"type":"integer"},"view":{"type":"integer"},"url":{"type":"string"},"title":{"type":"string"},"loading":{"type":"boolean"},"policy_exhausted":{"type":"boolean","description":"A network-policy budget latched: reads still answer, new traffic is refused"},"policy_exhausted_reason":{"type":"string"},"can_back":{"type":"boolean"},"can_fwd":{"type":"boolean"},"focused":{"type":"boolean"},"visible":{"type":"boolean"},"profile":{"type":"string"},"profile_kind":{"type":"string","enum":["default","named","ephemeral"]},"context":{"type":"integer"},"policy_active":{"type":"boolean"},"current":{"type":"boolean"}},"required":["url","title","loading","current"]}}},"required":["backend","count","helper","views"]}
        ,
    },
    .{
        .name = "web_open",
    ...
    .{
        ...
        ,
        .output_schema =
        \\{"type":"object","properties":{"backend":{"type":"string","enum":["gui","headless"]},"pane":{"type":"integer"},"view":{"type":"integer"},"origin":{"type":"string"},"url":{"type":"string"},"title":{"type":"string"},"loading":{"type":"boolean"},"policy_exhausted":{"type":"boolean"},"policy_exhausted_reason":{"type":"string"},"policy_active":{"type":"boolean"},"policy_source":{"type":"string","enum":["call","profile_default","none"]},"policy_serial":{"type":"integer"},"policy":{"type":"object"},"profile":{"type":"string"},"requests":{"type":"integer"},"bytes":{"type":"integer"},"navigations":{"type":"integer"},"ms_left":{"type":"integer","description":"Of deadline_ms; 0 when none is set or when it ran out (exhausted disambiguates)"},"exhausted":{"type":"boolean"},"exhausted_reason":{"type":"string","enum":["none","request_cap","byte_cap","nav_cap","deadline"]},"denied":{"type":"object","description":"Refusals by reason since the policy was installed"},"durable":{"type":"boolean","description":"Always false: policies and profile defaults live for this MCP server's lifetime only, by design"}},"required":["backend","policy_active"]}
        ,
    },
    .{
        .name = "web_policy_set",
        ...
        ,
        .output_schema =
        \\{"type":"object","properties":{"backend":{"type":"string","enum":["gui","headless"]},"pane":{"type":"integer"},"view":{"type":"integer"},"origin":{"type":"string"},"url":{"type":"string"},"title":{"type":"string"},"loading":{"type":"boolean"},"policy_exhausted":{"type":"boolean"},"policy_exhausted_reason":{"type":"string"},"profile":{"type":"string"},"policy_source":{"type":"string","enum":["call","profile_default","none"]},"policy_serial":{"type":"integer"},"policy":{"type":"object"},"durable":{"type":"boolean"},"tightened":{"type":"array","items":{"type":"string"},"description":"Fields the update actually narrowed"},"ignored":{"type":"array","items":{"type":"string"},"description":"Fields refused because they would loosen"}},"required":[]}
        ,
    },
    .{
        .name = "web_navigate",
        ...
        ,
        .output_schema =
        \\{"type":"object","properties":{"backend":{"type":"string","enum":["gui","headless"]},"pane":{"type":"integer"},"view":{"type":"integer"},"origin":{"type":"string"},"url":{"type":"string"},"title":{"type":"string"},"loading":{"type":"boolean"},"policy_exhausted":{"type":"boolean","description":"A network-policy budget latched: reads still answer, new traffic is refused"},"policy_exhausted_reason":{"type":"string"},"can_back":{"type":"boolean"},"can_fwd":{"type":"boolean"},"settled":{"type":"boolean"},"kind":{"type":"string","description":"Only with snapshot:delta/full - full or delta"},"document":{"type":"integer"},"revision":{"type":"integer"},"snapshot":{"type":"string","description":"Only with snapshot:delta/full - the semantic tree"},"snapshot_error":{"type":"string"}},"required":["backend","origin","url","title","loading","can_back","can_fwd","settled"]}
        ,
    },
    .{
        .name = "web_snapshot",
        ...
        ,
        .output_schema =
        \\{"type":"object","properties":{"backend":{"type":"string","enum":["gui","headless"]},"pane":{"type":"integer"},"view":{"type":"integer"},"origin":{"type":"string"},"url":{"type":"string"},"title":{"type":"string"},"loading":{"type":"boolean"},"policy_exhausted":{"type":"boolean","description":"A network-policy budget latched: reads still answer, new traffic is refused"},"policy_exhausted_reason":{"type":"string"},"kind":{"type":"string","description":"full or delta"},"document":{"type":"integer"},"revision":{"type":"integer"},"snapshot":{"type":"string","description":"The semantic tree, same text as the content block"},"snapshot_truncated":{"type":"boolean","description":"The tree was cut at the inline limit; snapshot_total_lines says how long it is. Narrow with scope"},"snapshot_total_lines":{"type":"integer"},"detail":{"type":"integer","description":"Echoed when passed"},"unchanged":{"type":"boolean","description":"A delta with an empty body: the page did not change"}},"required":["backend","origin","url","title","loading","kind","document","revision","snapshot"]}
        ,
    },
    .{
        .name = "web_act",
    ...
    .{
        ...
        ,
        .output_schema =
        \\{"type":"object","properties":{"backend":{"type":"string","enum":["gui","headless"]},"pane":{"type":"integer"},"view":{"type":"integer"},"origin":{"type":"string"},"url":{"type":"string"},"title":{"type":"string"},"loading":{"type":"boolean"},"policy_exhausted":{"type":"boolean","description":"A network-policy budget latched: reads still answer, new traffic is refused"},"policy_exhausted_reason":{"type":"string"},"id":{"type":"integer"},"offset":{"type":"integer"},"total_chars":{"type":"integer","description":"id 0 only: the full length of the stored eval result"},"source":{"type":"string","enum":["eval"],"description":"id 0 only"},"text":{"type":"string"}},"required":["backend","origin","url","title","loading","id","offset","text"]}
        ,
    },
    .{
        .name = "web_query",
        ...
        ,
        .output_schema =
        \\{"type":"object","properties":{"backend":{"type":"string","enum":["gui","headless"]},"pane":{"type":"integer"},"view":{"type":"integer"},"origin":{"type":"string"},"url":{"type":"string"},"title":{"type":"string"},"loading":{"type":"boolean"},"policy_exhausted":{"type":"boolean","description":"A network-policy budget latched: reads still answer, new traffic is refused"},"policy_exhausted_reason":{"type":"string"},"kind":{"type":"string","enum":["find_text","subtree","focused"]},"arg":{"type":"string"},"matches":{"type":"string","description":"Matching nodes in the same compact tree notation web_snapshot uses"}},"required":["backend","origin","url","title","loading","kind","matches"]}
        ,
    },
    .{
        .name = "web_read",
    ...
    .{
        ...
        ,
        .output_schema =
        \\{"type":"object","properties":{"backend":{"type":"string","enum":["gui","headless"]},"pane":{"type":"integer"},"view":{"type":"integer"},"origin":{"type":"string"},"url":{"type":"string"},"title":{"type":"string"},"loading":{"type":"boolean"},"policy_exhausted":{"type":"boolean","description":"A network-policy budget latched: reads still answer, new traffic is refused"},"policy_exhausted_reason":{"type":"string"},"waited_for":{"type":"string","enum":["load","title","text","idle"]},"arg":{"type":"string"},"settled":{"type":"boolean","description":"Always true; a condition that never held is an isError timeout"},"detail":{"type":"string","description":"What made the condition hold"}},"required":["backend","origin","url","title","loading","waited_for","settled","detail"]}
        ,
    },
    ...
    .{
        ...
        ,
        .output_schema =
        \\{"type":"object","properties":{"backend":{"type":"string","enum":["gui","headless"]},"pane":{"type":"integer"},"view":{"type":"integer"},"origin":{"type":"string"},"url":{"type":"string"},"title":{"type":"string"},"loading":{"type":"boolean"},"policy_exhausted":{"type":"boolean","description":"A network-policy budget latched: reads still answer, new traffic is refused"},"policy_exhausted_reason":{"type":"string"},"how":{"type":"string","description":"wheel, scroll_into_view, top, bottom, page_up or page_down"},"before":{"type":"object","properties":{"x":{"type":"integer"},"y":{"type":"integer"},"max_y":{"type":"integer"},"viewport":{"type":"integer"}}},"after":{"type":"object","properties":{"x":{"type":"integer"},"y":{"type":"integer"},"max_y":{"type":"integer"},"viewport":{"type":"integer"}}},"moved":{"type":"boolean"}},"required":["backend","origin","url","title","loading","how"]}
        ,
    },
    .{
        .name = "web_key",
    ...
    .{
        ...
        ,
        .output_schema =
        \\{"type":"object","properties":{"backend":{"type":"string","enum":["gui","headless"]},"pane":{"type":"integer"},"view":{"type":"integer"},"origin":{"type":"string"},"url":{"type":"string"},"title":{"type":"string"},"loading":{"type":"boolean"},"policy_exhausted":{"type":"boolean","description":"A network-policy budget latched: reads still answer, new traffic is refused"},"policy_exhausted_reason":{"type":"string"},"bytes":{"type":"integer"},"width":{"type":"integer"},"height":{"type":"integer"}},"required":["backend","origin","url","title","loading","bytes"]}
        ,
    },
    .{
        .name = "web_network",
