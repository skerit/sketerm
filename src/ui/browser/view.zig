...
pub const BrowserView = struct {
    ...
    pub const onMenuTags = @import("prompts.zig").onMenuTags;
    pub const onTagsActivate = @import("prompts.zig").onTagsActivate;
    ...
    pub const onMenuBatchRename = @import("prompts.zig").onMenuBatchRename;
    pub const onBatchRenameApply = @import("prompts.zig").onBatchRenameApply;
    ...
    pub const entryDialog = @import("prompts.zig").entryDialog;
    ...
    pub const onEntryDialogActivate = @import("prompts.zig").onEntryDialogActivate;
