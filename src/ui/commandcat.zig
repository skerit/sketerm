...
pub const curated = [_]Row{
    ...
    .{ .icon = "tab-new-symbolic", .title = "New Tab as Profile…",
       .desc = "Pick a profile, then open a new tab wearing its font, colours and shell.", .action = .new_tab_as_profile },
    .{ .icon = "document-edit-symbolic", .title = "Rename Tab…",
       .desc = "Give the current tab a title of its own.", .action = .rename_tab },
    .{ .icon = "color-select-symbolic", .title = "Set Tab Colour…",
       .desc = "Mark the current tab with a colour in the tab strip.", .action = .color_tab },
    ...
    .{ .icon = "document-edit-symbolic", .title = "Set Pane Title…",
       .desc = "Give the focused pane a title of its own, shown on its titlebar and tab.", .action = .set_pane_title },
    .{ .icon = "camera-photo-symbolic", .title = "Screenshot Pane…",
       .desc = "Save the focused pane as a PNG image.", .action = .screenshot_pane },
    .{ .icon = "view-refresh-symbolic", .title = "Reset Terminal",
       .desc = "Hard-reset the focused pane's screen: modes, colours, scroll region and cursor.", .action = .reset_terminal },
    .{ .icon = "folder-open-symbolic", .title = "Browse Files Here",
       .desc = "Give the focused pane a file browser at its working directory.", .action = .files_browse_here },
    .{ .icon = "system-file-manager-symbolic", .title = "Open in Sketerm Files",
       .desc = "Open the focused pane's working directory in the Sketerm Files window.", .action = .files_open_app },
    ...
    .{ .icon = "network-offline-symbolic", .title = "Detach Session",
       .desc = "Leave the focused durable session running in its daemon; the pane drops to a local shell.", .action = .mux_detach },
    .{ .icon = "document-edit-symbolic", .title = "Rename Session…",
       .desc = "Rename the focused durable mux session.", .action = .mux_rename },
    .{ .icon = "process-stop-symbolic", .title = "Kill Session",
       .desc = "End the focused durable mux session and everything running in it.", .action = .mux_kill },
    .{ .icon = "media-record-symbolic", .title = "Record Session (asciicast)…",
       .desc = "Record the focused session to a .cast file, written by the session's own host.", .action = .record_session },
    .{ .icon = "media-playback-stop-symbolic", .title = "Stop Session Recording",
       .desc = "Stop the focused session's asciicast recording.", .action = .record_session_stop },
    .{ .icon = "document-send-symbolic", .title = "Upload File…",
       .desc = "Send a local file to the focused pane's remote host.", .action = .upload_file },
    .{ .icon = "folder-download-symbolic", .title = "Download File…",
       .desc = "Fetch a file from the focused pane's remote host.", .action = .download_file },
    ...
    .{ .icon = "application-x-addon-symbolic", .title = "Extensions (Web)…",
       .desc = "Install, enable, disable or remove browser extensions (uBlock Origin and other MV2 add-ons).", .action = .web_extensions },
    .{ .icon = "text-x-script-symbolic", .title = "Userscripts (Web)…",
       .desc = "Add, enable or remove userscripts; granted GM_* functions work on every page they match.", .action = .web_userscripts },
    .{ .icon = "security-high-symbolic", .title = "Filter Lists (Web)…",
       .desc = "Subscribe to ad-block filter lists (EasyList and others) by url, or drop one; the browser keeps them updated.", .action = .web_filter_lists },
    ...
    .{ .icon = "view-paged-symbolic", .title = "Show Panel / Show Shell",
       .desc = "Swap this pane between the panel shown on it and its shell. Both stay alive; neither is closed.", .action = .toggle_panel_face },
    ...
    .{ .icon = "sketerm-rendering-symbolic", .title = "Pane Shader…",
       .desc = "Pick a custom post-process shader file for the focused pane.", .action = .shader_pick },
    .{ .icon = "preferences-other-symbolic", .title = "Configure Shader…",
       .desc = "Sliders and colours for the parameters the focused pane's shader declares.", .action = .configure_shader },
    .{ .icon = "edit-clear-symbolic", .title = "Clear Pane Shader",
       .desc = "Drop the focused pane's custom shader.", .action = .shader_clear },
