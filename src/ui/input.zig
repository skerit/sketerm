...
pub fn actionLabel(a: Action) []const u8 {
    return switch (a) {
        ...
        .new_tor_web_tab => "New web tab routed through Tor",
        .web_route_menu => "Route menu for this web tab (Direct / Tor / Via server / Browser runs on)",
        .web_route_direct => "Route this web tab directly (no proxy)",
        .web_route_tor => "Route this web tab through Tor",
        ...
        .web_extensions => "Browser extensions (install, enable, remove)",
        .web_userscripts => "Userscripts (add, enable, remove)",
        .web_filter_lists => "Ad-block filter lists (subscribe, unsubscribe)",
